...
Label(root,text="Name : Asmit Rai",fg="Dark Blue").grid(row=2,column=1,pady=30)
Label(root,text="Er : 211B075",fg="Dark Blue").grid(row=3,column=1)
Label(root,text="Mobile : 8858654154",fg="Dark Blue").grid(row=4,column=1,pady=30)
