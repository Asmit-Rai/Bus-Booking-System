...
# cur.execute("insert into Booking_history(Passenger_name ,Gender,No_of_passenger ,Phone,Age , B_Id,Date,Journey_date,Booking_ref,Boarding_station) values('Asmit ','Male',2,1234567890,19,1,'2022-10-29','2022-20-29',07,'Guna')")
con.commit()
